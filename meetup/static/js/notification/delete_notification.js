...
let delete_notification = Vue.component('delete_notification',{
    props:{
    ...
    data(){
        return {
            ...
            infoDelete: 'You will not be able to recover this Notification!',
    ...
    methods:{
        ...
        deleteLog(){
            ...
            HTTP.delete(`notification/delete/${self.rowDelete}`)
            .then((response) => {
                self.correctDelete = true;
                self.titleDelete = 'Deleted!'
                self.infoDelete = 'Your Notification  has been deleted.';
